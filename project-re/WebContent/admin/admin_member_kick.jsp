		...
		<div id="contents" class="col-10 container-fluid">
			<article class="row h-50">
				<div class="position-relative">
					<h3 class="position-absolute top-50 start-50 translate-middle-x">회원 강제 탈퇴</h3>
				</div>
				<div>
						...
						<table id="del_tab" class="table table-bordered border-dark w-50">
							<tr>
								<td colspan="2" class="text-center">
									탈퇴시키시려면 '<span class="text-danger">회원탈퇴</span>' 를 입력하세요
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="2" class="text-center">
									<input type="submit" class="btn btn-secondary btn-sm" value="탈퇴">
